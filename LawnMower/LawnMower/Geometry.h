...
public:
    ...
    { return type; }        
    virtual void Translate(float dx, float dy)      // desloca a geometria por (dx,dy)
    { x += dx; y += dy; }
...
public:
    ...
    float Ax() const { return x + a.X(); }          // coordenadas da janela do ponto A eixo x
    float Ay() const { return y + a.Y(); }          // coordenadas da janela do ponto A eixo y
    float Bx() const { return x + b.X(); }          // coordenadas da janela do ponto B eixo x
    float By() const { return y + b.Y(); }          // coordenadas da janela do ponto B eixo y
};
...
public:
    ...
    float Left() const   { return x + left; }       // coordenadas da janela do menor valor do eixo x
    float Top() const    { return y + top; }        // coordenadas da janela do menor valor do eixo y
    float Right() const  { return x + right; }      // coordenadas da janela do maior valor do eixo x
    float Bottom() const { return y + bottom; }     // coordenadas da janela do maior valor do eixo y
};
...
public:
    ...
    float CenterX() const { return x; }             // coordenadas da janela do centro (eixo x)
    float CenterY() const { return y; }             // coordenadas da janela do centro (eixo y)
};
